...
original_dataset = read.csv("training-tweets-siri.csv" , stringsAsFactors = F)
...
classifier = readRDS("siriclassifier.rds")
...
# saveRDS(classifier , "siriclassifier.rds")
# saveRDS(tweets.train , "siritrainingtweets.rds")
# saveRDS(tweets.test , "siritestingtweets.rds")
# saveRDS(y_pred , "siriprediction.rds")
...
Totalsirisentiments = c("Positve" = totalpositive , 
                          "Negative" = totalnegative , 
                          "Neutral" = totalneutral)

#saveRDS(Totalsirisentiments , file = "Siritotal.rds")
