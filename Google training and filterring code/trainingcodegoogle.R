...
original_dataset = read.csv("training-tweets-google.csv" , stringsAsFactors = F)
...
classifier = readRDS("googleclassifier.rds")
...
# saveRDS(classifier , "googleclassifier.rds")
# saveRDS(tweets.train , "googletrainingtweets.rds")
# saveRDS(tweets.test , "googletestingtweets.rds")
# saveRDS(y_pred , "googleprediction.rds")
...
Totalgooglesentiments = c("Positve" = totalpositive , 
                          "Negative" = totalnegative , 
                          "Neutral" = totalneutral)

#saveRDS(Totalgooglesentiments , file = "Googletotal.rds")
